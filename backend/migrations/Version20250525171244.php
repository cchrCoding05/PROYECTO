...
final class Version20250525171244 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE valoracion (id_valoracion INT AUTO_INCREMENT NOT NULL, id_usuario INT NOT NULL, id_profesional INT NOT NULL, id_intercambio_servicio INT DEFAULT NULL, id_intercambio_objeto INT DEFAULT NULL, puntuacion INT NOT NULL, comentario LONGTEXT DEFAULT NULL, fecha_creacion DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', INDEX IDX_6D3DE0F4FCF8192D (id_usuario), INDEX IDX_6D3DE0F433A1E3FF (id_profesional), INDEX IDX_6D3DE0F4F13CC80A (id_intercambio_servicio), INDEX IDX_6D3DE0F44C5CB3DF (id_intercambio_objeto), PRIMARY KEY(id_valoracion)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE mensaje ADD CONSTRAINT FK_9B631D01553E6F36 FOREIGN KEY (id_negociacion_precio) REFERENCES negociacion_precio (id_negociacion)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE mensaje ADD CONSTRAINT FK_9B631D01EFC5704C FOREIGN KEY (id_negociacion_servicio) REFERENCES negociacion_servicio (id_negociacion)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE negociacion_precio ADD CONSTRAINT FK_D61CDD99F862A056 FOREIGN KEY (id_comprador) REFERENCES usuario (id_usuario)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE negociacion_precio ADD CONSTRAINT FK_D61CDD99C74C74BB FOREIGN KEY (id_vendedor) REFERENCES usuario (id_usuario)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE valoracion ADD CONSTRAINT FK_6D3DE0F433A1E3FF FOREIGN KEY (id_profesional) REFERENCES usuario (id_usuario)
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE mensaje DROP FOREIGN KEY FK_9B631D01553E6F36
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE mensaje DROP FOREIGN KEY FK_9B631D01EFC5704C
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE negociacion_precio DROP FOREIGN KEY FK_D61CDD99F862A056
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE negociacion_precio DROP FOREIGN KEY FK_D61CDD99C74C74BB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE valoracion DROP FOREIGN KEY FK_6D3DE0F433A1E3FF
        SQL);
        $this->addSql(<<<'SQL'
