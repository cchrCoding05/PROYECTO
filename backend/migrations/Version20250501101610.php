 ...
 */
final class Version20250501101610 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE imagen_objeto ADD CONSTRAINT FK_20F052A17C537B FOREIGN KEY (id_objeto) REFERENCES objeto (id_objeto)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE imagen_servicio ADD CONSTRAINT FK_BAF585189B5D1EBF FOREIGN KEY (id_servicio) REFERENCES servicio (id_servicio)
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE imagen_objeto DROP FOREIGN KEY FK_20F052A17C537B
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE intercambio_objeto DROP FOREIGN KEY FK_CF7E017017C537B
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE imagen_servicio DROP FOREIGN KEY FK_BAF585189B5D1EBF
        SQL);
        $this->addSql(<<<'SQL'
