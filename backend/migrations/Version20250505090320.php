 ...
 */
final class Version20250505090320 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE negociacion_precio (id_negociacion INT AUTO_INCREMENT NOT NULL, id_usuario INT NOT NULL, id_intercambio INT NOT NULL, precio_propuesto INT NOT NULL, mensaje LONGTEXT DEFAULT NULL, aceptado TINYINT(1) NOT NULL, fecha_creacion DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', INDEX IDX_D61CDD99FCF8192D (id_usuario), INDEX IDX_D61CDD99188EA2DF (id_intercambio), PRIMARY KEY(id_negociacion)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
